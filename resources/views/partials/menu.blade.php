<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('app_setting_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/app-infos*") ? "c-show" : "" }} {{ request()->is("admin/app-updates*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('app_info_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.app-infos.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/app-infos") || request()->is("admin/app-infos/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-info-circle c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.appInfo.title') }}
                            </a>
                        </li>
                    @endcan
        ...
        @can('api_url_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.api-urls.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/api-urls") || request()->is("admin/api-urls/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-exchange-alt c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.apiUrl.title') }}
                </a>
            </li>
        @endcan
